...
import CompositionSectionBuilder from '../../../src/r5/models/backbones/CompositionSectionBuilder';
import ReferenceException from '../../../src/globals/exceptions/ReferenceException';
import { CompositionSectionValidator } from '../../../src/r5/models/backbones/CompositionSectionValidator';
import ICompositionSection from '../../../src/r5/interfaces/backbones/ICompositionSection';

describe('CompositionSection FHIR R5', () => {
  let builder: CompositionSectionBuilder;
  const { CompositionSection } = new FHIRContext().forR5();
