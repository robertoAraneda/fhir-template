...
import { Organization } from '../../../src/r4b/models/resources';
import { IOrganization } from '../../../src/r4b/interfaces/resources';
import { OrganizationBuilder } from '../../../src/r4b/builders/resources';

describe('Organization', () => {
  const context = new FHIRContext();
  const { validators: val } = context.forR4B();
