...
import { ICodeableConcept, IContactPoint, IIdentifier, IPeriod, IReference, ICoding } from '../../interfaces/datatypes';
...
class EndpointBuilder extends DomainResourceBuilder<EndpointBuilder> implements IEndpointBuilder {
