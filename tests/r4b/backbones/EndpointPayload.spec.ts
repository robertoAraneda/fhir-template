...
import { EndpointPayloadBuilder } from '../../../src/r4b/builders/backbones';
import { IEndpointPayload } from '../../../src/r4b/interfaces/backbones';

describe('EndpointPayload', () => {
  const { validators: val, builders } = new FHIRContext().forR4B();
