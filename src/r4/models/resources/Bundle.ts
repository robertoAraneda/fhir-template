...
import { IResourceBuilder, ResourceBuilder } from '../../builders/base/ResourceBuilder';
...
class BundleBuilder extends ResourceBuilder<BundleBuilder> implements IBundleBuilder {
