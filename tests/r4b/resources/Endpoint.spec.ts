import { EndpointBuilder } from '../../../src/r4b/builders/resources';
import { IEndpoint } from '../../../src/r4b/interfaces/resources';
import FHIRContext from '../../../src';
import { Endpoint } from '../../../src/r4b/models/resources';
import { IValidatorContext } from '../../../src/r4b';

describe('Endpoint', () => {
  let builder: EndpointBuilder;
  const context = new FHIRContext();
  const { validators: val, builders, createResource } = context.forR4B();
