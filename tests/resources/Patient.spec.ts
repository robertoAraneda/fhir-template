import { PatientBuilder } from '../../src/r5/builders/resources/PatientBuilder';
import { Patient } from '../../src/r5/interfaces/resources/Patient';
...
describe('Patient', () => {
  ...
  // create global
  beforeEach(() => {
    builder = ResourceBuilder.Patient();
  });
  ...
  it('should be able to create a new patient and validate with correct data [Example Patient/patient-example-sex-and-gender]', async () => {
    ...
    const validate = await ResourceValidator.Patient(dataType);
