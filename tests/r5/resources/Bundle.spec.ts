import { GroupBuilder } from '../../../src/r5/builders/resources';
import { IGroup } from '../../../src/r5/interfaces/resources';
import FHIRContext from '../../../src';
import { Group } from '../../../src/r5/models/resources';
...
describe('Bundle FHIR R5', () => {
  ...
  it('should be able to create a new bundle and validate with correct data [IGroup]', async () => {
    const item: IGroup = {
      resourceType: 'Group',
      id: '101',
  ...
  it('should be able to create a new bundle and validate with correct data [new Group()]', async () => {
  ...
  it('should be able to create a new bundle and validate with correct data [createResource]', async () => {
  ...
  it('should be able to create a new bundle and validate with correct data [Group-example-patientlist.json]', async () => {
    const item: IGroup = {
      resourceType: 'Group',
  ...
  it('should be able to create a new bundle with builder methods [new GroupBuilder()]', async () => {
  ...
  it('should be able to create a new bundle with builder methods [Builder.resources.Group()]', async () => {
    const bundle = builderFromFunction
      .setActive(true)
      .setName('Name')
      .setType('animal')
      .addMember({
